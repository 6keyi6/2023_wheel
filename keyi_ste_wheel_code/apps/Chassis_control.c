...
void Chassis_PID_Init(void)
{
		...
		{
			//跟随
			PositionPID_paraReset(&M6020_OUT[i],17.f,0,0,29000,20000);
			PositionPID_paraReset(&M6020_IN[i],100.f,0.,0,29000,20000);
			//原跟随 1.3    10 0.8
			PositionPID_paraReset(&Class_OUT[i],1.4f,0.f,0.f,16000,8000);
...
{
	  if(DevicesGet_State(CHAS_RUD2_MONITOR) == Off_line)
		{
			asdf++;
		}
		//获取编码器值
