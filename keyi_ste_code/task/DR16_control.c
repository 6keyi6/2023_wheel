...
//			 Set_VisionMode(Vision_Top); /*<! 击打小陀螺模式 */
//		}
//		else if(remote_control.keyBoard.key_code != 16384 && Vision_Top_flag1 == 0)
//		{
//       Vision_Top_flag1 = 1;
//			 Set_VisionMode(Vision_Forcast);//预测
//		}			
...
//		if(GetKeyMouseAction(KEY_R,KeyAction_LONG_PRESS) && mag_flag == 1) 			/*<! 长R 弹仓开关 */
//		{			
//				mag_flag = 0;		
//				if(Mag_Switch == ON)
//				{
...
//				}																  
//		}						
//		else if(remote_control.keyBoard.key_code != 256 && mag_flag == 0)
//		{	
//				mag_flag = 1;														
//		}	
