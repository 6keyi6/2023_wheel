...
#define GIMBAL_PIT_MIN		4700	 // Pit 编码仰角限位 
#define GIMBAL_PIT_MAX		6000  	 // Pit 编码俯角限位
#define GIMBAL_PIT_CENTRE 	5150


#define GIMBAL_PIT_MIN1		4700	 // Pit 编码仰角限位 
#define GIMBAL_PIT_MAX1		6000  	 // Pit 编码俯角限位
/**
  * @brief  云台总控制函数
  * @param  void
  * @retval None
