...
//	if(Vision_Mode == Vision_BIGWindmill)//打符模式下进行滤波
//	{
//		first_order_filter_cali(&first_order_filter_BIG_YAW,0.1);
//		first_order_filter_cali(&first_order_filter_BIG_PIT,0.1);
//	}
...
//     KalmanFilter(&yaw_vision, VisionData.RawData.yaw_angle);	 
    ...
    if(VisionData.RawData.mode == 0 ) //视觉找不到目标
    {
		...
		//硬件NAN值错误！！
//   if(isnan(VisionData.RawData.yaw_angle))
//		{	
//			VisionData.RawData.yaw_angle = 0;
//			yaw_nan++;
//		}	
//    if(isnan(VisionData.RawData.pitch_angle))
//		{
//			VisionData.RawData.pitch_angle = 0;
//			pit_nan++;
//		}
