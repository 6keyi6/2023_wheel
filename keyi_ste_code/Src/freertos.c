...
//			DataScope_Get_Channel_Data(Frict_motor.RC_FrictL,1);
//	 		DataScope_Get_Channel_Data(Frict_motor.Frict_CurL,2);	
//			DataScope_Get_Channel_Data(Frict_motor.RC_FrictR,3);
//			DataScope_Get_Channel_Data(-Frict_motor.Frict_CurR,4);
//			DataScope_Get_Channel_Data(M6020_motor.remote_control_YAW,1);
